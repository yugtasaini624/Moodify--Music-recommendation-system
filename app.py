...
def home():
    if request.method == "POST":
        try:
            ...
            input_list = [sleep_hours, screen_time, activity, time_of_day, mood_scale, social_pref]
            predicted_mood = predictor(input_list, model, time_encoder, activity_encoder, mood_encoder, colns)
